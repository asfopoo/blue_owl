<img src = https://github.com/asfopoo/blue_owl/blob/master/src/images/blueOwl.jpeg alt="Hoot" width="400" height="200"/>  
...
---
#### How To Run 
- Once you have followed the installation instructions you are ready to run the application, you can do so by <br/> entering the command $ yarn start while still in the blue_owl directory<br/>
---
#### TroubleShooting
